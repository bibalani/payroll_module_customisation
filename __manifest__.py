...

{
    ...
    'data': [
        ...
        'data/consultancy_NI_NOT_H_90_data.xml',
        'data/Normal_I_OT_data.xml',
        'data/Normal_I_OT_Effective_data.xml',
        'wizard/hr_payroll_contribution_register_report_views.xml',
        'views/res_config_settings_views.xml',
        'views/report_contributionregister_templates.xml',
        'views/report_payslip_templates.xml',
        'views/report_payslipdetails_templates.xml',
        'views/hr_pay_period_views.xml',
        'views/hr_payslip_input_views.xml',
        'views/hr_tax_profile_views.xml',
        'views/hr_insurance_profile_views.xml',
    ],
